{ config, lib, pkgs, inputs, myUser, ... }:
{
  ...
  #options.gui.gaming = {
  #  steam = { 
  #    enable = lib.mkEnableOption "Enables preconfigured steam";
  #    decky-loader.enable = lib.mkEnableOption "Enables decky loader";
  #    gamescope-session = {
  #      enable = lib.mkEnableOption "Enables Gamescope session";
  #      hdr = lib.mkEnableOption "Enables configuration for hdr";
  #    };
  #  };
  #};
